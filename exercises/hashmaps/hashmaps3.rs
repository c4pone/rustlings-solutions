...
impl Team {
    fn new(name: String, goals_scored: &u8, goals_conceded: &u8) -> Team {
        Team {
            name: name,
            goals_scored: goals_scored.clone(),
            goals_conceded: goals_conceded.clone(),
        }
    }

    fn add(&mut self, goals: &u8, conceded: &u8) {
...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        scores
            ...
            .and_modify(|team| team.add(&team_1_score, &team_2_score))
            .or_insert(Team::new(team_1_name, &team_1_score, &team_2_score));
        scores
            .entry(team_2_name.clone())
            .and_modify(|team| team.add(&team_2_score, &team_1_score))
